function original() {
    ...
    $('#title').html('Welcome to the <br> official website of <br><b>Eric Zhu.</b>');
    ...
    $('link[rel=stylesheet][href~="whitequote.css"]').remove();
}
...
$('#home').hover(
  function() {
    ...
    $('head').append('<link rel="stylesheet" href="whitequote.css" type="text/css" />');
  }, original
);

$('#about').hover(
  function() {
    $('body').css('background-image','url(https://scontent-lga1-1.xx.fbcdn.net/hphotos-xpa1/v/t1.0-9/11204387_10204348879497973_588776871060301950_n.jpg?oh=47c9c7caaf5c336bb79c62819d2963b5&oe=55EABFDC)');
    $('#navbar').css('background-image','none');
    $('#navbar').css('background-color','white');
    $('#navbar').css('opacity','0.5');
    ...
    $('.quote').html("But the law of loving others could not be discovered <br> by reason, because it is unreasonable.");
...
$('#thread').hover(
  function() {
    ...
    $('.quote').html("Sometimes I can feel my bones straining under the <br> weight of all the lives I'm not living.");
...
$('#contact').hover(
  function() {
    ...
    $('#title').text("");
    $('.quote').html("Death really did not matter to him but life did, and therefore <br>the sensation he felt when they gave their decision was <br>not a feeling of fear but of nostalgia.");
