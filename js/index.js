...
$(document).ready(function() {
  $('.glyphicon-question-sign').hover(
    function() {
      $('body').append('<div id="what-is-this">Welcome! Here are some books I\'ve read, photos I\'ve taken, and pieces I\'ve played. I think they tell a decent story of who I am. Hover over the arrows to follow the thread!</div>');
    },
    function() {
      $('#what-is-this').remove();   
    }
